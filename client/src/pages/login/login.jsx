...
export default function Login(){
    ...
    const handleClick = (e) => {
        e.preventDefault();
        loginCall({email:email.current.value,password, password:password.current.value},dispatch);
    }
            ...
            <div className="loginWrapper">
                ...
                <div className="loginRight">
                    <form className="loginBox" onSubmit = {handleClick}>
                        ...
                        <button className="loginRegisterButton">{isFetching ? <CircularProgress color="secondary" size="20px" /> : "Create a new account"}</button>
                    </form>
                </div>
            </div>
        </div>
